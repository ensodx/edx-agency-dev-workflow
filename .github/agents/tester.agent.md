---
name: tester
description: Writes and reviews tests that validate functional correctness against acceptance criteria. Use after a feature is implemented. Does not implement features or evaluate code quality.
model: claude-sonnet-4-6
tools: ['vscode', 'execute', 'read', 'edit', 'search', 'memory', 'todo']
---
